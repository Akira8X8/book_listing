...
/**
 * FetchTask
 * queries the Google Books API, receives the results, parsing them, building
 * an ArrayList of Book Objects, and returns the result
 */
class FetchTask extends AsyncTask<String, Void, ArrayList<Book>> {
    ...
    // Constructor
    public FetchTask(AsyncResponse delegate, String queryURI) {
        ...
        if (jsonResults != null) {
            try {
                ...
                for (int i = 0; i < countResults; i++) {
                    ...
                    // Some books don't have authors listed, use try/catch to prevent null pointers
